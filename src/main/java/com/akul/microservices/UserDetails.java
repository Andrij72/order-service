...
public class UserDetails extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1696074380656098973L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserDetails\",\"namespace\":\"com.akul.microservices\",\"fields\":[{\"name\":\"email\",\"type\":\"string\"},{\"name\":\"firstName\",\"type\":\"string\"},{\"name\":\"lastName\",\"type\":\"string\"}]}");
   ...
   */
  public UserDetails(java.lang.CharSequence email, java.lang.CharSequence firstName, java.lang.CharSequence lastName) {
    this.email = email;
   ...
   */
  public static com.akul.microservices.UserDetails.Builder newBuilder() {
    return new com.akul.microservices.UserDetails.Builder();
  }
   ...
   * @return A new UserDetails RecordBuilder
   */
  public static com.akul.microservices.UserDetails.Builder newBuilder(com.akul.microservices.UserDetails.Builder other) {
    if (other == null) {
      return new com.akul.microservices.UserDetails.Builder();
    } else {
      return new com.akul.microservices.UserDetails.Builder(other);
    }
  }
   ...
   * @return A new UserDetails RecordBuilder
   */
  public static com.akul.microservices.UserDetails.Builder newBuilder(com.akul.microservices.UserDetails other) {
    if (other == null) {
      return new com.akul.microservices.UserDetails.Builder();
    } else {
      return new com.akul.microservices.UserDetails.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserDetails>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.akul.microservices.UserDetails.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.akul.microservices.UserDetails other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.email)) {
        this.email = data().deepCopy(fields()[0].schema(), other.email);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.akul.microservices.UserDetails.Builder setEmail(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.akul.microservices.UserDetails.Builder clearEmail() {
      email = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.akul.microservices.UserDetails.Builder setFirstName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.akul.microservices.UserDetails.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.akul.microservices.UserDetails.Builder setLastName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.akul.microservices.UserDetails.Builder clearLastName() {
      lastName = null;
